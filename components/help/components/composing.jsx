...
export default function HelpComposing() {
    ...
    message.push(localizeMessage('help.composing.deleting', '## Deleting a message\nDelete a message by clicking the **[...]** icon next to any message text that you\'ve composed, then click **Delete**. System and Community Admins can delete any message on their system or team.'));
